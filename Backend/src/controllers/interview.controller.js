...
//controller to get interview report based on user self description,resume and job description .
...
async function getAllInterviewReportsController(req,res){
    ...
    sort({createdAt:-1}).select("-resume -selfDescriptions -jobDescription -__v -technicalQuestions -behavioralQuestions -skillGaps -preprationPlan")
